...
You can read more about the project in the full documentation(in Polish): [Sprawozdanie z projektu procesora w języku VHDL.pdf](https://github.com/user-attachments/files/26165860/Sprawozdanie.z.projektu.procesora.w.jezyku.VHDL.pdf)
