...
You can read more about the project in the full documentation(in Polish):[Sprawozdanie z projektu procesora w języku VHDL](<./sprawozdanie procesora w języku VHDL.pdf>)
